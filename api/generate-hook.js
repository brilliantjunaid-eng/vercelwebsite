...
export default async function handler(req, res) {
 ...
 var prompt = [
  ...
  "",
   "- lowSupport/midSupport/highSupport: these are NOT study instructions or task suggestions.",
  "- They are short emotional nudges, 1 sentence each, specific to the feeling of studying THIS topic.",
  "- BAD: 'Start by reading a brief overview' or 'Watch a documentary'",
  "- GOOD: 'Every empire you study is secretly a story about one person trying to hold everything together.'",
